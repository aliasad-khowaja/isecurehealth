...
const spanish: Record<string, string> = {
  ...
  "Professional guidance for confident healthcare decisions.": "Orientación profesional para tomar decisiones de salud con confianza.",
  "We believe everyone deserves to understand their healthcare choices and feel confident about the path forward. We provide personalized support for individuals, families, self-employed professionals, and people comparing Medicare, Medicaid, marketplace, life, dental, vision, group, travel, or short-term coverage options.": "Creemos que todos merecen comprender sus opciones de atención médica y sentirse seguros del camino a seguir. Brindamos apoyo personalizado a personas, familias, profesionales independientes y quienes comparan opciones de Medicare, Medicaid, mercado de seguros, vida, dental, visión, grupos, viajes o cobertura a corto plazo.",
  ...
  "iSecure Health helps you compare coverage options with clarity, understand what matters for your budget and care needs, and move forward with guidance that feels personal, practical, and pressure-free.": "iSecure Health te ayuda a comparar opciones de cobertura con claridad, comprender lo que importa para tu presupuesto y necesidades de atención, y avanzar con una orientación personal, práctica y sin presión.",
  "How we help": "Cómo ayudamos",
  "Coverage guidance for real life": "Orientación de cobertura para la vida real",
  "Explore the services we offer and get clear, personal support for the coverage decisions that matter most.": "Explora los servicios que ofrecemos y recibe apoyo claro y personal para las decisiones de cobertura que más importan.",
  ...
  "Medicare and Medicaid choices can be difficult to compare on your own. We help you understand available plans, eligibility considerations, benefits, provider access, and cost factors so you can choose coverage that supports your healthcare needs and budget.": "Las opciones de Medicare y Medicaid pueden ser difíciles de comparar por tu cuenta. Te ayudamos a comprender los planes disponibles, requisitos de elegibilidad, beneficios, acceso a proveedores y factores de costo para que puedas elegir una cobertura que apoye tus necesidades de salud y presupuesto.",
  "Whether you are shopping for yourself or your household, we make health insurance easier to evaluate. Our guidance helps you compare plan types, monthly costs, deductibles, prescriptions, doctor networks, and practical coverage details before you decide.": "Ya sea que busques cobertura para ti o para tu hogar, hacemos que el seguro médico sea más fácil de evaluar. Nuestra orientación te ayuda a comparar tipos de planes, costos mensuales, deducibles, medicamentos, redes de médicos y detalles prácticos antes de decidir.",
  "Life insurance is about protecting the people who depend on you. We help you review coverage options, understand policy differences, and think through the amount of protection that may fit your family, goals, and long-term financial responsibilities.": "El seguro de vida se trata de proteger a las personas que dependen de ti. Te ayudamos a revisar opciones de cobertura, comprender diferencias entre pólizas y pensar en la protección que puede ajustarse a tu familia, metas y responsabilidades financieras a largo plazo.",
  "For employers and organizations, the right group coverage can support both people and business goals. We help compare practical options for teams, explain plan details clearly, and support decision-making for growing workplaces.": "Para empleadores y organizaciones, la cobertura grupal adecuada puede apoyar tanto a las personas como los objetivos del negocio. Ayudamos a comparar opciones prácticas para equipos, explicar detalles de planes con claridad y apoyar decisiones para lugares de trabajo en crecimiento.",
  "Temporary coverage can be useful during travel, transitions, waiting periods, or changes in employment. We help you understand short-term and travel insurance options so you can avoid gaps and choose protection that fits the moment.": "La cobertura temporal puede ser útil durante viajes, transiciones, períodos de espera o cambios de empleo. Te ayudamos a comprender opciones de seguro a corto plazo y de viaje para evitar interrupciones y elegir protección adecuada para el momento.",
  "Dental and vision coverage can help with routine care, exams, eyewear, preventive services, and unexpected needs. We help you compare options that can complement your healthcare coverage and support everyday wellness.": "La cobertura dental y de visión puede ayudar con atención de rutina, exámenes, lentes, servicios preventivos y necesidades inesperadas. Te ayudamos a comparar opciones que pueden complementar tu cobertura médica y apoyar el bienestar diario.",
  ...
  "A simple path from questions to confident coverage.": "Un camino sencillo desde las preguntas hasta una cobertura con confianza.",
  "We make the process easier by listening first, explaining your options clearly, and helping you take the next step with confidence.": "Hacemos que el proceso sea más fácil escuchando primero, explicando tus opciones con claridad y ayudándote a dar el siguiente paso con confianza.",
